...
import JobDetailsExtraPart from '../JobDetailsExtraPart/JobDetailsExtraPart';
const Jobdetails = () => {
            ...
            <div className='container mx-auto mt-20 mb-20 grid md:grid-cols-3'>
                ...
                <div className=' bg-slate-100 w-96 h-96 p-5  rounded-lg container mx-auto'>
                    <div className=''>
                        ...
                        <p className='mt-3'> <span className='mt-2 font-semibold'>Salary  : </span>{salary}</p>
                        <p > <span className='mt-2 font-semibold'>Job Title : </span>{title}</p>
                    </div>
                    ...
                    <div className=' md:col-span-1'>
                        ...
                        <p className='mt-3'><span className='mt-2 font-semibold'>Phone : </span>{phone}</p>
                        <p><span className='mt-2 font-semibold'>Email : </span>{Email}</p>
                        <p> <span className='mt-2 font-semibold'>Phone : </span>{location}</p>
                    </div>
                    <button className='text-white mt-24 bg-gradient-to-r from-indigo-600 to-blue-500 p-3 rounded w-full text-center my-2' >Apply Now</button>
